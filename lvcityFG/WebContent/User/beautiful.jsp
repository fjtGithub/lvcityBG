...
<div class="container"> 		
	...
	<div class="banner_erji">
		<img src="../images/banner_erji1.jpg" width="1000" height="187" alt="" title="">        
    </div>
	<!--banner end--> 
	...
	<div class="content clearfix">
		<div class="leftbar">
			...
			<iframe id="fengjing" name="fengjing" src="<%=basePath%>/beautiful/showlist.do?stid=${firstscenictypeid}&pageNow=1"  
				style="float:right;width:712px;height:665px;border:1px solid #cccccc;background-color:white;"></iframe>
            </div>
        </div>
